...
import com.pf.projectboard.domain.constant.FormStatus;
import com.pf.projectboard.domain.constant.SearchType;
import com.pf.projectboard.dto.ArticleDto;
import com.pf.projectboard.dto.ArticleWithCommentsDto;
import com.pf.projectboard.dto.UserAccountDto;
import com.pf.projectboard.dto.request.ArticleRequest;
import com.pf.projectboard.dto.response.ArticleResponse;
import com.pf.projectboard.service.ArticleService;
import com.pf.projectboard.service.PaginationService;
...
class ArticleControllerTest {
    ...
    @Test
    public void givenNothing_whenRequestingArticlesSearchHashtagView_thenReturnsArticleSearchHashtagView() throws Exception {
        // Given
    ...
    void givenNothing_whenRequesting_thenRedirectsToLoginPage() throws Exception {
        ...
        // When & Then
        mvc.perform(get("/article/" + articleId + "/form"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrlPattern("**/login"));
        then(articleService).shouldHaveNoInteractions();
